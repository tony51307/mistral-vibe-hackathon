...
from vibe.cli.tts import MistralTTSClient, TTSResult
...
def _make_model() -> TTSModelConfigView:
    return TTSModelConfigView(
        name="voxtral-mini-tts-latest", voice="gb_jane_neutral", response_format="wav"
    )
